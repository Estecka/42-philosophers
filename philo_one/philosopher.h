...
/*   Updated: 2021/02/10 14:57:30 by abaur            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
** @var int ttaction	The date in milliseconds when the philosopher will compl
** ete its ongoing action.
** @var int ttdie	The date in milliseconds when the philosopher will starve.
...
** Their first action upon being born will be to crave for spaghettis.
*/
